...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    def get_ego_actor():
        """
        Get the actor object of the ego actor if it exists, returns none otherwise.
        """
        # print("REACH EGO FUNCTION")
        # for actor_id in CarlaDataProvider._carla_actor_pool:
        #     print(actor_id)
        #     if CarlaDataProvider._carla_actor_pool[actor_id].attributes['role_name'] == 'ego_vehicle':
        #         return CarlaDataProvider._carla_actor_pool[actor_id]
        # return None
        if CarlaDataProvider._world is None:
    ...
    def cleanup():
        ...
        for actor_id in CarlaDataProvider._carla_actor_pool.copy():
            ...
            if actor is not None and actor.is_alive and actor.attributes['role_name'] != "ego_vehicle":
